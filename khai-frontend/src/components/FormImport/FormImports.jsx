    ...
    const registerSchema = Yup.object().shape(
        {
            bl: Yup.string()
                ...
                .required("El bl es requerido"),
            condition: Yup.string()
                .required("La condicion es requerida"),
            product: Yup.string()
                .required("El tipo de producto es requerido"),
            shipper: Yup.string()
                .required("El exportador es requerido"),
            consignee: Yup.string()
                .required("El consignatario es requerido"),
            weigth: Yup.string()
            ...
            buque: Yup.string()
                .required("El buque es requerido"),
            arrival: Yup.string()
                .required("La fecha de arribo es requerida"),
        }
    )
    ...
    return (
            <Formik
                ...
                onSubmit={async (values) => {                    
                    ...
                    const response = await createOperation(operation.bl, operation.condition, operation.product, operation.shipper, operation.consignee, operation.weigth, operation.rate, operation.origen, operation.buque, operation.arrival);
            ...
            >
                {({ errors, touched, isSubmitting }) => (
                    <Form className="formLogin">
                        ...
                        <button type="submit" className="boton">Agregar operacion</button>
